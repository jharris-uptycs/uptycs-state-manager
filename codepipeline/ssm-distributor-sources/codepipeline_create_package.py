...
AUTHFILE = ''
ssm_parameter_path = os.environ['PARAMETER_PATH']
PACKAGE_DESCRIPTION = \
...
class UptApiAuth:
    ...
    def __init__(self, ssm_parameter=None, api_config_file=None, silent=True):
        ...
        elif ssm_parameter is not None:
            self.get_json_from_ssm_parameter(parameter_name=ssm_parameter, 
                                                     with_decrypt=True)
...
class UptApiCall:
    ...
    def __init__(self, api_endpoint, method, payload=None, **kwargs):
        ...
        self.logger = LogHandler(str(self.__class__))
        try:
            self.api_auth = UptApiAuth(ssm_parameter=ssm_parameter_path)
